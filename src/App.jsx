...
export default function App() {
  ...
  const [respostaSorteada, setRespostaSorteada] = useState(null);
  ...
  const escolher = (need) => {
    setEscolha(need);
    setRespostaSorteada({
      porQue: pick(POR_QUE[need]),
      acoes: pick(ACOES[need]),
      frase: pick(FRASES_FINAIS[need]),
    });
    setPhase("result");
  };
          ...
          <>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ background: "#111e30", border: "1px solid " + need.color + "33", borderRadius: 14, overflow: "hidden" }}>
                <div style={{ padding: "12px 20px", borderBottom: "1px solid #1a2a4a", background: need.color + "10" }}>
                  <span style={{ fontFamily: "'DM Serif Display'", fontSize: 16, color: need.color }}>{respostaSorteada?.porQue?.titulo}</span>
                </div>
                <div style={{ padding: "16px 20px" }}>
                  <p style={{ fontSize: 14, lineHeight: 1.75, color: "#a0b0c0", fontFamily: "'DM Sans'" }}>{respostaSorteada?.porQue?.texto}</p>
                </div>
              </div>
            </div>
            ...
            <div style={{ marginBottom: 24 }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: 10 }}>
                {respostaSorteada?.acoes?.map((a, i) => (
            ...
            <div style={{ background: need.color + "15", border: "1px solid " + need.color + "33", borderRadius: 14, padding: "22px", marginBottom: 28 }}>
              ...
              <p style={{ fontFamily: "'DM Serif Display'", fontSize: 16, lineHeight: 1.7, fontStyle: "italic" }}>{respostaSorteada?.frase}</p>
            </div>
            ...
            <div style={{ textAlign: "center", display: "flex", flexDirection: "column", gap: 12, alignItems: "center" }}>
              <button onClick={() => { setEscolha(null); setRespostaSorteada(null); setPhase("opcoes"); }} style={{ background: "transparent", color: "#7a9abf", border: "1px solid #7a9abf44", borderRadius: 8, padding: "11px 22px", fontSize: 12, fontWeight: 600, letterSpacing: "0.08em", fontFamily: "'DM Sans'", cursor: "pointer" }}>
